                                ...
                                <span
                                    ...
                                    style={{
                                        ...
                                        fontWeight: (() => {
                                            ...
                                            if (['founderdaily', 'founderbusinesstips', 'foundersoncrack', 'Life Wealth Lessons', 'Billionaires of Bharat', 'indian hustle advice', 'indian-founders-co', 'Finding Good AI', 'Finding Good Tech', 'startupsinthelast24hrs', 'indian ai future', 'startupbydog'].includes(preset.name)) return 400;
