...
const PreviewCard = memo(({
    ...
    const isPoppinsFont = (isAicrackedOrEvolvingPreset && presetNameLower !== 'bestindianpodcast') ||
        ...
        preset.name === 'Real India Business';
                                ...
                                <span
                                    ...
                                    style={{
                                        ...
                                        fontWeight: (() => {
                                            ...
                                            if (['founderdaily', 'founderbusinesstips', 'foundersoncrack', 'Life Wealth Lessons', 'Billionaires of Bharat', 'indian hustle advice', 'rich indian ceo', 'founders cracked', 'indian-founders-co', 'Entrepreneurial India', 'Finding Good AI', 'Finding Good Tech', 'startupsinthelast24hrs', 'indian ai future'].includes(preset.name)) return 400;
