...
const INITIAL_PRESETS_RAW = [
    ...
    { id: 80, name: 'indian-founders-co-tweet', handle: '@indianfoundersco', ratio: '4:3', color: '#2cb162', active: true, layout: 'social', logo: 'indian-founders-co.png', headline: DEFAULT_HEADLINE, footer: DEFAULT_FOOTER, position: { x: 50, y: 50 }, creditPosition: { x: 0, y: 0.5 }, watermarkPosition: { x: 50, y: 16 }, headlinePosition: { x: 0, y: 0 }, showLogo: true, alignment: 'left', lineSpacing: 1.25 },
];
                                ...
                                <span
                                    ...
                                    style={{
                                        ...
                                        fontWeight: (() => {
                                            ...
                                            if (['founderdaily', 'founderbusinesstips', 'foundersoncrack', 'Life Wealth Lessons', 'Billionaires of Bharat', 'indian hustle advice', 'indian-founders-co', 'Finding Good AI', 'Finding Good Tech', 'startupsinthelast24hrs', 'indian ai future'].includes(preset.name)) return 400;
