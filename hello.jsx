...
const INITIAL_PRESETS_RAW = [
    ...
    { id: 4, name: 'Business Cracked', handle: '@businesscracked', ratio: '1:1', color: '#fdeb01', active: true, layout: 'social', logo: LOGO_BUSINESS_CRACKED, headline: DEFAULT_HEADLINE, footer: DEFAULT_FOOTER, position: { x: 50, y: 50 }, creditPosition: { x: 0, y: 0.5 }, watermarkPosition: { x: 50, y: 16 }, headlinePosition: { x: 0, y: 0 }, showLogo: true, alignment: 'center', lineSpacing: 1.25 },
    ...
    { id: 11, name: 'Real India Business', handle: '@realindianbusiness', ratio: '4:3', color: '#8a2bff', active: true, layout: 'logo_centered', logo: LOGO_REALINDIABUSINESS, headline: DEFAULT_HEADLINE, footer: DEFAULT_FOOTER, position: { x: 50, y: 50 }, creditPosition: { x: 0, y: 0.5 }, watermarkPosition: { x: 50, y: 16 }, headlinePosition: { x: 0, y: 0 }, showLogo: true, alignment: 'center', lineSpacing: 1.25 },
    ...
    { id: 22, name: 'wealth lessons india', handle: '@wealthlessonsindia', ratio: '4:3', color: '#ff9c06', active: true, layout: 'social', logo: null, headline: DEFAULT_HEADLINE, footer: DEFAULT_FOOTER, position: { x: 50, y: 50 }, creditPosition: { x: 0, y: 0.5 }, watermarkPosition: { x: 50, y: 16 }, headlinePosition: { x: 8, y: 0 }, showLogo: false, alignment: 'left', lineSpacing: 1.25 },
    ...
    { id: 28, name: 'indian business com', handle: '@indianbusinesscom', ratio: '1:1', color: '#ffffff', active: true, layout: 'social', logo: 'indian-business-com.png', headline: DEFAULT_HEADLINE, footer: DEFAULT_FOOTER, position: { x: 50, y: 50 }, creditPosition: { x: 0, y: 0.5 }, watermarkPosition: { x: 50, y: 16 }, headlinePosition: { x: 0, y: 0 }, showLogo: true, alignment: 'left', lineSpacing: 1.25 },
    ...
    { id: 46, name: 'indianstartupstory', handle: '@indianstartupstory', ratio: '4:3', color: '#EF5350', active: true, layout: 'watermark', logo: null, headline: DEFAULT_HEADLINE, footer: DEFAULT_FOOTER, position: { x: 50, y: 50 }, creditPosition: { x: 0, y: 0.5 }, watermarkPosition: { x: 50, y: 16 }, headlinePosition: { x: 0, y: 0 }, showLogo: false, alignment: 'center', lineSpacing: 1.25 },
...
const PreviewCard = memo(({
    ...
    const isAicrackedOrEvolvingPreset =
        ...
        presetNameLower === 'indianstartupstory' ||
        ...
        >
            ...
            <div className={`flex-1 w-full flex flex-col ${justifyClass} relative ${(preset.name === 'founderdaily' || preset.name === 'founderbusinesstips' || preset.name === 'foundersoncrack' || preset.name === 'kwazyfounders' || preset.name === 'startup madness') ? 'bg-white' : 'bg-neutral-900'}`}>
                            ...
                            <div className={`flex items-center w-full ${preset.name === 'Business Cracked' ? 'justify-center gap-[4px]' : 'justify-start gap-2'}`} style={preset.name === 'Business Cracked' ? { transform: 'translateX(-20px)' } : {}}>
                                ...
                                {(preset.name !== 'The Real Founder' && preset.name !== 'Inspiring Founder' && preset.name !== 'founders cracked' && preset.name !== 'indian business com') && (
                                    <div className="flex flex-col text-left">
                                        <div className={`flex items-center ${preset.name === 'Business Cracked' ? 'gap-[28px]' : 'gap-4'}`}>
                                            <span className={`text-xs font-bold leading-none ${(preset.name === 'founderdaily' || preset.name === 'founderbusinesstips' || preset.name === 'foundersoncrack' || preset.name === 'kwazyfounders') ? 'text-black' : 'text-white'}`}>{preset.name === 'founders-in-india' ? 'Foundersinindia' : (preset.name === 'mktg-wtf' ? 'mktg Wtf' : (preset.name === 'Entrepreneurial India' ? 'Entrepreneurial.India' : preset.name))}</span>
                                            <BadgeCheck className="w-3 h-3 text-blue-500 fill-blue-500 text-black" />
                                        </div>
                                        <span className={`text-[9px] font-medium leading-tight mt-0.5 ${(preset.name === 'founderdaily' || preset.name === 'founderbusinesstips' || preset.name === 'foundersoncrack' || preset.name === 'kwazyfounders') ? 'text-neutral-700' : 'text-neutral-400'}`}>{preset.handle}</span>
                                    </div>
                                )}
                            </div>
                        )}
                ...
                {preset.name !== 'Best Founder Clips' && preset.name !== 'best business clips' && preset.name !== 'startup madness' && preset.name !== 'Ads by marketer' && (
                    <div
                        ref={headlineRef}
                        className={`w-full z-10 leading-tight drop-shadow-lg tracking-tighter relative ${isRepositioningHeadline ? 'cursor-move ring-2 ring-yellow-500' : ''} ${isCenterAligned ? 'flex flex-col items-center' : 'flex flex-col items-start'}`}
                        style={{
                ...
                >
                    ...
                    <div className={`absolute inset-0 w-full h-full overflow-hidden pointer-events-none ${(preset.name === 'founderdaily' || preset.name === 'founderbusinesstips' || preset.name === 'foundersoncrack' || preset.name === 'kwazyfounders' || preset.name === 'startup madness') ? 'bg-white' : 'bg-black'}`}>
                        {videoSrc ? (
                            <video
                                ref={(el) => {
                                    if (isMain) {
                        ...
                        {/* WATERMARK OVERLAY */}
                        {preset.layout === 'watermark' && preset.name !== 'The Rising Founder' && preset.name !== 'ceo hustle advice' && preset.name !== 'peakofai' && preset.name !== 'theprimefounder' && preset.name !== 'neworderai' && !isAicrackedOrEvolvingPreset && (
                            <div
                                ref={watermarkRef}
                ...
                {showCredit && preset.name !== 'peakofai' && preset.name !== 'theprimefounder' && preset.name !== 'neworderai' && !isAicrackedOrEvolvingPreset && (
                    ...
                    >
                        ...
                        <p className={`text-[8px] font-bold font-inter ${(preset.name === 'founderdaily' || preset.name === 'founderbusinesstips' || preset.name === 'foundersoncrack' || preset.name === 'kwazyfounders' || preset.name === 'startup madness') ? 'text-black' : 'text-white'}`} style={{
                            letterSpacing: '0.5px',
                            color: (preset.name === 'founderdaily' || preset.name === 'founderbusinesstips' || preset.name === 'foundersoncrack' || preset.name === 'kwazyfounders' || preset.name === 'startup madness') ? '#000000' : undefined,
                            textShadow: 'none'
                        }}>
                            {preset.footer}
                        </p>
